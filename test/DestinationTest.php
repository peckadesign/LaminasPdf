...
class DestinationTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testLoad()
    {
        ...
        // \LaminasPdf\Destination\FitHorizontally
        $destArray = new InternalType\ArrayObject();
        $destArray->items[] = $page2->getPageDictionary();
        ...
        // \LaminasPdf\Destination\FitVertically
        $destArray = new InternalType\ArrayObject();
        $destArray->items[] = $page2->getPageDictionary();
        ...
        // \LaminasPdf\Destination\FitRectangle
        $destArray = new InternalType\ArrayObject();
        $destArray->items[] = $page2->getPageDictionary();
        ...
        // \LaminasPdf\Destination\FitBoundingBox
        $destArray = new InternalType\ArrayObject();
        $destArray->items[] = $page2->getPageDictionary();
        ...
        // \LaminasPdf\Destination\FitBoundingBoxHorizontally
        $destArray = new InternalType\ArrayObject();
        $destArray->items[] = $page2->getPageDictionary();
        ...
        // \LaminasPdf\Destination\FitBoundingBoxVertically
        $destArray = new InternalType\ArrayObject();
        $destArray->items[] = $page2->getPageDictionary();
