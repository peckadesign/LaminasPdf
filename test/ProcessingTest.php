...
class ProcessingTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testModify()
    {
        ...
        foreach ($pdf->pages as $page) {
            ...
            $page->rotate(0, 0, M_PI_2 / 3)
                ->drawText('Modified by Laminas', 150, 0)
                ->restoreGS();
        }
    ...
    public function testPageDuplicating()
    {
        ...
        foreach ($pdf->pages as $srcPage) {
            ...
            $page->rotate(0, 0, M_PI_2 / 3);
            $page->drawText('Modified by Laminas', 150, 0);
            $page->restoreGS();
        }
     ...
     * @group ZF-3701
     */
    public function testLaminasPdfIsExtendableWithAccessToProperties()
    {
...
class ExtendedLaminasPDF extends Pdf\PdfDocument
{
...
class ExtendedLaminasPDFPage extends Pdf\Page
{
    public function __get($name)
    {
        if (isset($this->$name)) {
